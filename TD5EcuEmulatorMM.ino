...
//    digitalWrite(ledPin, LOW);     
  ...
  if (iso_compare_data(dataResponse, dataStreamFuelling14, 4))
  {
    ...
    // Send the message
    byte dataStream[] = {0x14, 0x61, 0x1D, 0xFE, 0x0C, 0x75, 0x30, 0x11, 0x3E, 0x00, 0x00, 0x00, 0x00, 0x0F, 0xA0, 0x00, 0x00, 0x15, 0x7C, 0x00, 0x28, 0xF8};   // 0xF8 (checksum)
    //byte dataStream[] = {0x14, 0x61, 0x1D, 0xFE, 0x0C, 0x75, 0x30, 0x11, 0x3E, 0x55, 0x40, 0x00, 0x00, 0x0F, 0x0A, 0x00, 0x00, 0x15, 0x7C, 0x00, 0x28, 0x9D};   // injection q set to 64
    for (byte i = 0; i < 22; i++)
    {
      iso_write_byte(dataStream[i]);
    }
